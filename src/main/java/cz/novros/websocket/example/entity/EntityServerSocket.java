...
/**
 * Server socket for sending and receiving {@link Entity}. The important part is define {@link
 * ServerEndpoint#decoders()} for sending and {@link ServerEndpoint#encoders()} for receiving.
 */
